...
const Contact = () => {
    ...
    const APPS_SCRIPT_URL =
        "https://script.google.com/macros/s/AKfycbyJtTOoAykpE5OfQ07p-P0Vp4yVnHxPgkEVjSmlwgSibSHZf_X27XQ9xJ7xz5JovqV9cw/exec";
    ...
    const socialLinks = [
        ...
        {
            icon: Linkedin,
            url: "https://www.linkedin.com/in/gokul-k-97694a2507",
            label: "LinkedIn",
        },
    ];
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="text-center mb-16 animate-fadeInUp">
                    ...
                    <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                        Have a project idea, internship opportunity, or software
                        development role? Feel free to reach out. I'm always
                        interested in discussing technology, software
