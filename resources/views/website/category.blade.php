...
@section('title', ucfirst($subcategory) . ' - ' . ucfirst($category))

@section('content')
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold text-center mb-8">{{ ucfirst($subcategory) }} - {{ ucfirst($category) }}</h1>
    ...
    @else
        <div class="text-center py-12">
            <h2 class="text-xl text-gray-600">No {{ $subcategory }} available in {{ $category }} category</h2>
